...
if (worldName == "Tanoa") then
    ...
    if (worldName == "Altis") then
        ...
        if (worldName == "chernarus") then
            {
            _posAntenas = [[6444.13,6545.83,-0.106628],[5264.35,5314.45,0.0291748],[4968.53,9964.4,0],[3715.81,5984.25,0],[6563.69,3405.56,0.0547104],[4548.22,3131.85,0.570232],[13010.1,5964.96,-0.0164185],[3029.57,2350.28,0.0183334],[13477.6,3345.84,0.0729446],[12937,12763.6,0.164017],[11542.2,11266.9,-0.000671387],[8190.19,9069.28,0],[8197.13,6712.02,-3.05176e-005],[3288.13,4488.61,0],[4081.17,11675,0],[12619.7,4361.98,-0.000732422]];
            _blackListPos = [1,7];
            antenas = [];
            }
        else
