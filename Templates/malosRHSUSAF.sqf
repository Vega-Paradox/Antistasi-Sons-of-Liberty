...
vehNATOLightArmed = ["rhsgref_cdf_b_reg_uaz_dshkm","rhsgref_cdf_b_reg_uaz_ags","rhsgref_cdf_b_reg_uaz_spg9","rhsgref_BRDM2_vdv","rhsgref_BRDM2_HQ_vdv","rhsgref_BRDM2_ATGM_vdv"];
vehNATOLightUnarmed = ["rhsgref_cdf_b_reg_uaz","rhsgref_cdf_b_reg_uaz_open"];
vehNATOTrucks = ["rhsgref_cdf_b_gaz66","rhsgref_cdf_b_gaz66o","rhsgref_cdf_b_gaz66_flat","rhsgref_cdf_b_gaz66o_flat","rhsgref_cdf_b_ural","rhsgref_cdf_b_ural_open","rhsgref_cdf_b_zil131","rhsgref_cdf_b_zil131_open","rhsgref_cdf_b_zil131_flatbed_cover","rhsgref_cdf_b_zil131_flatbed"];
vehNATOAmmoTruck = "rhsgref_cdf_b_gaz66_ammo";
vehNATORepairTruck = "rhsgref_cdf_b_gaz66_repair";
vehNATOLight = vehNATOLightArmed + vehNATOLightUnarmed;
vehNATOAPC = ["rhsgref_cdf_b_btr60","rhsgref_cdf_b_btr70","rhsgref_cdf_b_bmd1","rhsgref_cdf_b_bmd1p","rhsgref_cdf_b_bmd2","rhsgref_cdf_b_bmp1","rhsgref_cdf_b_bmp1p","rhsgref_cdf_b_bmp2","rhsgref_cdf_b_bmp2d"];
vehNATOTank = "rhsgref_cdf_b_t80b_tv";
...
vehNATOPlane = "rhsgref_cdf_b_su25";
vehNATOPlaneAA = "rhsgref_cdf_b_mig29s";
vehNATOPatrolHeli = "rhsgref_cdf_b_reg_Mi8amt";
vehNATOTransportHelis = ["rhsgref_cdf_b_reg_Mi8amt","rhsgref_cdf_b_Mi24D","RHS_AN2"];
...
vehNATONormal = vehNATOLight + vehNATOTrucks + [vehNATOAmmoTruck,["rhsgref_cdf_b_ural_fuel"],vehNATORepairTruck];
vehNATOBike = "I_G_Quadbike_01_F";
NATOFlag = "FlagCarrierCDF";
NATOFlagTexture = "\cdf_flag.png";
...
gruposNATOAA = ["rhsgref_cdf_b_reg_squadleader","rhsgref_cdf_b_reg_machinegunner","rhsgref_cdf_b_reg_rifleman","rhsgref_cdf_b_reg_specialist_aa"];
gruposNATOAT = ["rhsgref_cdf_b_reg_squadleader","rhsgref_cdf_b_reg_machinegunner","rhsgref_cdf_b_reg_rifleman","rhsgref_cdf_b_reg_grenadier_rpg"];
gruposNATOmid = [["rhsgref_cdf_b_reg_squadleader","rhsgref_cdf_b_reg_machinegunner","rhsgref_cdf_b_reg_rifleman_akm","rhsgref_cdf_b_reg_grenadier_rpg"],gruposNATOAA,gruposNATOAT];//["B_T_InfTeam","B_T_InfTeam_AA","B_T_InfTeam_AT"];///
NATOSquad = ["rhsgref_cdf_b_reg_squadleader","rhsgref_cdf_b_reg_machinegunner","rhsgref_cdf_b_reg_rifleman_akm","rhsgref_cdf_b_reg_medic","rhsgref_cdf_b_reg_machinegunner","rhsgref_cdf_b_reg_rifleman_akm","rhsgref_cdf_b_reg_marksman"];//"B_T_InfSquad";//
