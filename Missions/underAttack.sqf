...
[_lado,_marcador,[format ["%2 is attacking us in %1. Join the fight and defend %1!",_nombreDest,_nombreEny],format ["%1 Contact Rep",_nombreEny],_marcador],getMarkerPos _marcador,false,0,true,"Defend",true] call BIS_fnc_taskCreate;
